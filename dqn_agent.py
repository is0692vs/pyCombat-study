...
class DQNAgent:
    def __init__(self, state_size, action_size):
        ...
        self.memory = deque(maxlen=10000)  # リプレイバッファのサイズを増やす
        self.gamma = 0.95  # discount rate
        self.epsilon = 1.0  # exploration rate
        self.epsilon_min = 0.01
        self.epsilon_decay = 0.99
        self.batch_size = 64  # バッチサイズを増やす
        ...
        self.player_optimizer = optim.Adam(self.player_q_network.parameters(), lr=0.001)
        self.enemy_optimizer = optim.Adam(self.enemy_q_network.parameters(), lr=0.001)
